...
You just need conseq installed since everything else that is required is installed inside the us-central1-docker.pkg.dev/depmap-consortium/depmap-docker-images/daintree-sparkles:v4 image where predicability is run.
