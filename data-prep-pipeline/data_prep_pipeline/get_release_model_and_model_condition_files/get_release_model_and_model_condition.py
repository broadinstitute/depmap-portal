...
def main():
    ...
    model_df = gumbo_df_preprocessing(
        gumbo_client, data_dictionary_model_df, orig_model_df
    )
    ...
    model_condition_df = gumbo_df_preprocessing(
        gumbo_client, data_dictionary_model_condition_df, orig_model_condition_df
    )
