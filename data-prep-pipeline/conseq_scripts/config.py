# These taigaids will probably change in each data release cycle
hgnc_gene_table_taiga_id = (
    "hgnc-gene-table-e250.3/hgnc_complete_set"  # This is needed for fusion data
)
