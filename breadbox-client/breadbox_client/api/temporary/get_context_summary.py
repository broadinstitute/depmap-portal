...
from ...models.context_summary import ContextSummary
...
) -> Optional[Union[ContextSummary, HTTPError, HTTPValidationError]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ContextSummary.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ContextSummary, HTTPError, HTTPValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ContextSummary, HTTPError, HTTPValidationError]
    """
