...
) -> Optional[Union[HTTPError, HTTPValidationError, UploadFileResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPError, HTTPValidationError, UploadFileResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPError, HTTPValidationError, UploadFileResponse]
    """
