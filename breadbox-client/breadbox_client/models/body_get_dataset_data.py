...
T = TypeVar("T", bound="BodyGetDatasetData")


@_attrs_define
class BodyGetDatasetData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_get_dataset_data.additional_properties = d
        return body_get_dataset_data
