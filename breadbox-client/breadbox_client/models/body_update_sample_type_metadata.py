...
T = TypeVar("T", bound="BodyUpdateSampleTypeMetadata")


@_attrs_define
class BodyUpdateSampleTypeMetadata:
    """
    Attributes:
        metadata_file (File):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_update_sample_type_metadata = cls(
            metadata_file=metadata_file,
        ...
        body_update_sample_type_metadata.additional_properties = d
        return body_update_sample_type_metadata
