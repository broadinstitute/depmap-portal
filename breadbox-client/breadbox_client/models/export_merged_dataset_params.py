...
T = TypeVar("T", bound="ExportMergedDatasetParams")


@_attrs_define
class ExportMergedDatasetParams:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        export_merged_dataset_params = cls(
        ...
        export_merged_dataset_params.additional_properties = d
        return export_merged_dataset_params
