...
T = TypeVar("T", bound="TableDatasetParamsColumnsMetadata")


@_attrs_define
class TableDatasetParamsColumnsMetadata:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_dataset_params_columns_metadata = cls()
        ...
        table_dataset_params_columns_metadata.additional_properties = (
            additional_properties
        )
        return table_dataset_params_columns_metadata
