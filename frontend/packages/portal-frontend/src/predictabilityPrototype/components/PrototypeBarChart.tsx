...
export interface PrototypeBarChartProps {
  title: string;
...
type PrototypeBarChartWithPlotly = PrototypeBarChartProps & {
  Plotly: PlotlyType;
};
...
export default function LazyPrototypeBarChart({
  title,
  categoryValues,
  categoryLabels,
  customColors,
