...
import DataTabs from "src/dataPage/components/DataTabs";
...
export const DataPage = ({ releaseNotesUrl, forumUrl }: DataPageProps) => {
    ...
    >
      ...
      <main className={styles.main}>
        <DataTabs
          ...
          termsDefinitions={{ test: "testVal" }} // TODO fix this
