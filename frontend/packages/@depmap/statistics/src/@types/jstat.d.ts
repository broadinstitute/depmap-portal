// Type definitions have not yet been officially added for this library.
// The types below are taken from this pull request:
// https://github.com/jstat/jstat/pull/271/files
