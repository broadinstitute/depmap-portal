...
def test_slice_labels_of_dataset(app, empty_db_mock_downloads):
    """
    Mock datasets with overlapping entities. 
    Check that all slice labels are loaded for the given dataset
    """
    ...
    with app.test_client() as c:
        r = c.get(
            url_for(
                "data_explorer_2.slice_labels_of_dataset",
                slice_type="gene",
