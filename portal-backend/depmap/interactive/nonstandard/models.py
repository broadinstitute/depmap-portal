...
class NonstandardMatrix(Model):
    ...
    _row_index = relationship("RowNonstandardMatrix", lazy="select")
    _col_index = relationship("ColNonstandardMatrix", lazy="select")
    ...
    data_type: "Column[enums.DataTypeEnum]" = Column(
        sqlalchemy.Enum(DataTypeEnum, name="DataTypeEnum"), nullable=False
    )
