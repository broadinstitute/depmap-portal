...
class DependencyEnum(DatasetEnum):
    ...
    Prism_oncology_unified_AUC = "Prism_oncology_unified_AUC"
    Prism_oncology_unified_dose_replicate = "Prism_oncology_unified_dose_replicate"
    ...
    def is_compound_experiment_enum(dataset_enum):
        ...
        return dataset_enum in {
            ...
            DependencyEnum.Prism_oncology_unified_AUC,
        }
...
class BiomarkerEnum(DatasetEnum):
    ...
    oncref_unified_confounders = "oncref_unified_confounders"
