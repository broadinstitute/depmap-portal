...
class Mutation(Model):
    ...
    dida_id = Column(String)
    dida_name = Column(String)
    ...
    lof_gene_name = Column(String)
    gnomade_af = Column(Float)
    lof_gene_id = Column(String)
    ...
    lof_percent_of_transcripts_affected = Column(Float)
    ...
    lof_number_of_transcripts_in_gene = Column(Integer)
