...
def _get_overview_table(overview_page_table, summary_df_by_model_id):
    ...
    overview_page_table_joined = overview_page_table_joined.rename(
        columns={
            ...
            "PRISMOncRefUnified": "oncrefUnified",
...
def _get_enriched_lineages_tile_with_caching(tree_type, feature_id, feature_type):
    ...
    tile_data = EnrichedLineagesTileData(
        ...
        # for the frontend to determine the tab of context_explorer to link to: "oncrefLum", "oncrefSeq", "oncrefUnified", "repurposing", or "geneDependency"
